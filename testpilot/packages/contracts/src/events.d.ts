 ...
 */
export type Event = ExecutionStartedEvent | ExecutionCompletedEvent | ExecutionFailedEvent | AgentStartedEvent | AgentCompletedEvent | AgentFailedEvent | ToolStartedEvent | ToolCompletedEvent | ToolFailedEvent;
/**
